...
##third-party
from peft import PeftModel, PeftConfig, PEFT_TYPE_TO_CONFIG_MAPPING
import torch 

class AdaptedPeft(PeftModel):
    """
...
class CustomPeftModel:
    ...
    def peft_from_model(
            ...
            adapter_name:str = "default" ) -> AdaptedPeft:
        """
         :param model: existing pytorch model
        :param peft_config: PeftConfig, config file for peft model
        :param adapter_name: str, adapter name (default = 'default)
        """
        return AdaptedPeft(model, peft_config, adapter_name)
