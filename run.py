...
if __name__ == "__main__":
    ...
    io_args.add_argument('--target_tasks', nargs="+", default=['sentence_repetition'], help="Specify target tasks for dataset.")
    io_args.add_argument('--target_features', nargs="+", default=['hoarse_harsh', 'slow_rate', 'sound_distortions', 'monopitch_monoloudness', 'inappropriate_silences_or_prolonged_intervals'], help="Specify target features for dataset.")
